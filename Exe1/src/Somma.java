...
public class Somma {
	...
	public static void main(String[] args) {
		//Definizione dello shared object che conterr� un intero
		...
		//La lettura di a e b pu� avvenire in modo pi� o meno elegante, ad
		//es. da linea di comando con:
		//int a = Integer.parseInt(args[0]);
	    //int b = Integer.parseInt(args[1]);
		//oppure tramite lo stream System.in.
		//Qu� ci limitiamo ad assegnarli direttamente con:
		int a = 3;
		int b = 5; 
		...
		try {
			...
			//sommatore
			doSum.join();//senza join il padre potrebbe avere come risultato = 0 perchè figlio non ha ancora fatto la somma
